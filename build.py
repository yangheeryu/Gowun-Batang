...
print ("[Gowun Batang] Converting to UFO")
main(("glyphs2ufo", "sources/GowunBatang.glyphs", "--write-public-skip-export-glyphs", "--propagate-anchors"))
...
for ufo in path.glob("*.ufo"):
    shutil.rmtree(ufo)
os.remove("sources/GowunBatang.designspace")